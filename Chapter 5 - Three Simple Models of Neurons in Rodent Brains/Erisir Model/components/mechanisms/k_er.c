...
#define nrn_init _nrn_init__k_er
#define _nrn_initial _nrn_initial__k_er
#define nrn_cur _nrn_cur__k_er
#define _nrn_current _nrn_current__k_er
#define nrn_jacob _nrn_jacob__k_er
#define nrn_state _nrn_state__k_er
#define _net_receive _net_receive__k_er 
#define rate rate__k_er 
#define states states__k_er 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 k_er C:/Users/strou/Documents/Git/Borgers-Examples-in-BMTK/Chapter 5 - Three Simple Models of Neurons in Rodent Brains/Erisir Model/components/mechanisms/k_er.mod\n");
...
static int  rate ( _threadargsprotocomma_ double _lv ) {
   ...
   tau = ( exp ( 5.0 / 59.0 * _lv ) - 3136.4518 ) * exp ( 500.0 / 11111.0 * _lv ) / ( ( _lv - 95.0 ) * exp ( 0.129746 * _lv ) + 0.025 * exp ( 5.0 / 59.0 * _lv ) - 78.411296 ) ;
     return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "k_er.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
